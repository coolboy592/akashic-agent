...
| 插件 v3 proactive source/module、background job 与 LLM capability | [插件 v3 Proactive / background job 合同](design/plugin-v3-proactive-jobs-task-contract.md) → [Default/Wake Proactive 私有兼容岛合同](design/plugin-v3-private-proactive-island-task-contract.md) → [插件 v3 MCP/managed process 合同](design/plugin-v3-mcp-managed-process-task-contract.md) → [持久化状态地图](design/persistence-state-map.md) | `agent/plugins/activity_host.py`、`agent/plugins/jobs.py`、`proactive_v2/lifecycle.py`、`proactive_v2/loop.py`、`bootstrap/proactive.py` |
| 插件 v3 inbound/outbound channel capability | [插件 v3 Channel capability 合同](design/plugin-v3-channel-capability-task-contract.md) → [插件 v3 committed command catalog 合同](design/plugin-v3-command-catalog-task-contract.md) | `agent/plugin_composition/`、`agent/plugins/manager.py`、`agent/plugins/snapshot.py`、`agent/tools/message_push.py`、`agent/looping/core.py`、`agent/core/passive_turn.py`、`agent/lifecycle/phases/after_turn.py`、`agent/turns/orchestrator.py`、`agent/turns/outbound.py`、`bootstrap/app.py`、`bootstrap/channel_host.py`、`bootstrap/channels.py`、`bootstrap/passive_worker.py`、`bus/queue.py`、`bus/events.py`、`infra/channels/contract.py`、`infra/channels/delivery.py`、`infra/channels/telegram_channel.py`、`infra/channels/qq_channel.py`、`infra/channels/web_chat_channel.py`、`infra/mobile_realtime/channel.py`、`/mnt/data/coding/akashic-plugin/feishu`、`/mnt/data/coding/akashic-plugin/qqbot` |
